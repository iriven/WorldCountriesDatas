...
final class Iso3166DataProvider implements Countable, IteratorAggregate
{
    ...
    private $KnowledgeBase = [
        ...
        ['AG', 'ATG', '028', 'XCD', 'East Caribbean Dollar', '+1-268', 'Antigua and Barbuda', 'St. John\'s', '.ag', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-AG', ''],
        ['AI', 'AIA', '660', 'XCD', 'East Caribbean Dollar', '+1-264', 'Anguilla', 'The Valley', '.ai', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-AI', ''],
        ...
        ['AN', 'ANT', '530', 'ANG', 'Netherlands Antillean Guilder', '599', 'Netherlands Antilles', 'Willemstad', '.an', 'NA', '019', 'Americas', '021', 'Northern America', 'nl-AN,en,es', ''],
        ['AO', 'AGO', '024', 'AOA', 'Kwanza', '244', 'Angola', 'Luanda', '.ao', 'AF', '002', 'Africa', '017', 'Middle Africa', 'pt-AO', ''],
        ['AQ', 'ATA', '010', '', '', '', 'Antarctica', '', '.aq', 'AN', '', '', '', '', '', ''],
        ['AR', 'ARG', '032', 'ARS', 'Argentine Peso', '54', 'Argentina', 'Buenos Aires', '.ar', 'SA', '019', 'Americas', '005', 'South America', 'es-AR,en,it,de,fr,gn', '^[A-Z]?\d{4}[A-Z]{0,3}$'],
        ...
        ['AW', 'ABW', '533', 'AWG', 'Aruban Florin', '297', 'Aruba', 'Oranjestad', '.aw', 'NA', '019', 'Americas', '029', 'Caribbean', 'nl-AW,es,en', ''],
        ...
        ['BB', 'BRB', '052', 'BBD', 'Barbados Dollar', '+1-246', 'Barbados', 'Bridgetown', '.bb', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-BB', '^(?:BB)*(\d{5})$'],
        ...
        ['BL', 'BLM', '652', 'EUR', 'Euro', '590', 'Saint Barthelemy', 'Gustavia', '.gp', 'NA', '019', 'Americas', '029', 'Caribbean', 'fr', ''],
        ['BM', 'BMU', '060', 'BMD', 'Bermudian Dollar', '+1-441', 'Bermuda', 'Hamilton', '.bm', 'NA', '019', 'Americas', '021', 'Northern America', 'en-BM,pt', '^([A-Z]{2}\d{2})$'],
        ['BN', 'BRN', '096', 'BND', 'Brunei Dollar', '673', 'Brunei', 'Bandar Seri Begawan', '.bn', 'AS', '142', 'Asia', '035', 'South-Eastern Asia', 'ms-BN,en-BN', '^([A-Z]{2}\d{4})$'],
        ['BO', 'BOL', '068', 'BOB', 'Boliviano', '591', 'Bolivia (Plurinational State of)', 'Sucre', '.bo', 'SA', '019', 'Americas', '005', 'South America', 'es-BO,qu,ay', ''],
        ['BQ', 'BES', '535', 'USD', 'US Dollar', '599', 'Bonaire, Saint Eustatius and Saba', '', '.bq', 'NA', '019', 'Americas', '021', 'Northern America', 'nl,pap,en', ''],
        ['BR', 'BRA', '076', 'BRL', 'Brazilian Real', '55', 'Brazil', 'Brasilia', '.br', 'SA', '019', 'Americas', '005', 'South America', 'pt-BR,es,en,fr', '^\d{5}-\d{3}$'],
        ['BS', 'BHS', '044', 'BSD', 'Bahamian Dollar', '+1-242', 'Bahamas', 'Nassau', '.bs', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-BS', ''],
        ...
        ['BZ', 'BLZ', '084', 'BZD', 'Belize Dollar', '501', 'Belize', 'Belmopan', '.bz', 'NA', '019', 'Americas', '013', 'Central America', 'en-BZ,es', ''],
        ['CA', 'CAN', '124', 'CAD', 'Canadian Dollar', '1', 'Canada', 'Ottawa', '.ca', 'NA', '019', 'Americas', '021', 'Northern America', 'en-CA,fr-CA,iu', '^([ABCEGHJKLMNPRSTVXY]\d[ABCEGHJKLMNPRSTVWXYZ]) ?(\d[ABCEGHJKLMNPRSTVWXYZ]\d)$'],
        ...
        ['CL', 'CHL', '152', 'CLP', 'Chilean Peso', '56', 'Chile', 'Santiago', '.cl', 'SA', '019', 'Americas', '005', 'South America', 'es-CL', '^(\d{7})$'],
        ...
        ['CO', 'COL', '170', 'COP', 'Colombian Peso', '57', 'Colombia', 'Bogota', '.co', 'SA', '019', 'Americas', '005', 'South America', 'es-CO', ''],
        ['CR', 'CRI', '188', 'CRC', 'Costa Rican Colon', '506', 'Costa Rica', 'San Jose', '.cr', 'NA', '019', 'Americas', '013', 'Central America', 'es-CR,en', '^(\d{4})$'],
        ['CU', 'CUB', '192', 'CUP', 'Cuban Peso', '53', 'Cuba', 'Havana', '.cu', 'NA', '019', 'Americas', '029', 'Caribbean', 'es-CU', '^(?:CP)*(\d{5})$'],
        ['CV', 'CPV', '132', 'CVE', 'Cabo Verde Escudo', '238', 'Cape Verde', 'Praia', '.cv', 'AF', '002', 'Africa', '011', 'Western Africa', 'pt-CV', '^(\d{4})$'],
        ['CW', 'CUW', '531', 'ANG', 'Netherlands Antillean Guilder', '599', 'Curacao', 'Willemstad', '.cw', 'NA', '019', 'Americas', '029', 'Caribbean', 'nl,pap', ''],
        ...
        ['DM', 'DMA', '212', 'XCD', 'East Caribbean Dollar', '+1-767', 'Dominica', 'Roseau', '.dm', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-DM', ''],
        ['DO', 'DOM', '214', 'DOP', 'Dominican Peso', '+1-809 and 1-829', 'Dominican Republic', 'Santo Domingo', '.do', 'NA', '019', 'Americas', '029', 'Caribbean', 'es-DO', '^(\d{5})$'],
        ['DZ', 'DZA', '012', 'DZD', 'Algerian Dinar', '213', 'Algeria', 'Algiers', '.dz', 'AF', '002', 'Africa', '015', 'Northern Africa', 'ar-DZ', '^(\d{5})$'],
        ['EC', 'ECU', '218', 'USD', 'US Dollar', '593', 'Ecuador', 'Quito', '.ec', 'SA', '019', 'Americas', '005', 'South America', 'es-EC', '^([a-zA-Z]\d{4}[a-zA-Z])$'],
        ...
        ['FK', 'FLK', '238', 'FKP', 'Falkland Islands Pound', '500', 'Falkland Islands (Malvinas)', 'Stanley', '.fk', 'SA', '019', 'Americas', '005', 'South America', 'en-FK', ''],
        ...
        ['GD', 'GRD', '308', 'XCD', 'East Caribbean Dollar', '+1-473', 'Grenada', 'St. George\'s', '.gd', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-GD', ''],
        ['GE', 'GEO', '268', 'GEL', 'Lari', '995', 'Georgia', 'Tbilisi', '.ge', 'AS', '142', 'Asia', '145', 'Western Asia', 'ka,ru,hy,az', '^(\d{4})$'],
        ['GF', 'GUF', '254', 'EUR', 'Euro', '594', 'French Guiana', 'Cayenne', '.gf', 'SA', '019', 'Americas', '005', 'South America', 'fr-GF', '^((97|98)3\d{2})$'],
        ...
        ['GL', 'GRL', '304', 'DKK', 'Danish Krone', '299', 'Greenland', 'Nuuk', '.gl', 'NA', '019', 'Americas', '021', 'Northern America', 'kl,da-GL,en', '^(\d{4})$'],
        ...
        ['GP', 'GLP', '312', 'EUR', 'Euro', '590', 'Guadeloupe', 'Basse-Terre', '.gp', 'NA', '019', 'Americas', '029', 'Caribbean', 'fr-GP', '^((97|98)\d{3})$'],
        ...
        ['GT', 'GTM', '320', 'GTQ', 'Quetzal', '502', 'Guatemala', 'Guatemala City', '.gt', 'NA', '019', 'Americas', '013', 'Central America', 'es-GT', '^(\d{5})$'],
        ...
        ['GY', 'GUY', '328', 'GYD', 'Guyana Dollar', '592', 'Guyana', 'Georgetown', '.gy', 'SA', '019', 'Americas', '005', 'South America', 'en-GY', ''],
        ...
        ['HN', 'HND', '340', 'HNL', 'Lempira', '504', 'Honduras', 'Tegucigalpa', '.hn', 'NA', '019', 'Americas', '013', 'Central America', 'es-HN', '^([A-Z]{2}\d{4})$'],
        ['HR', 'HRV', '191', 'HRK', 'Kuna', '385', 'Croatia', 'Zagreb', '.hr', 'EU', '150', 'Europe', '039', 'Southern Europe', 'hr-HR,sr', '^(?:HR)*(\d{5})$'],
        ['HT', 'HTI', '332', 'HTG', 'Gourde', '509', 'Haiti', 'Port-au-Prince', '.ht', 'NA', '019', 'Americas', '029', 'Caribbean', 'ht,fr-HT', '^(?:HT)*(\d{4})$'],
        ...
        ['JM', 'JAM', '388', 'JMD', 'Jamaican Dollar', '+1-876', 'Jamaica', 'Kingston', '.jm', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-JM', ''],
        ...
        ['KN', 'KNA', '659', 'XCD', 'East Caribbean Dollar', '+1-869', 'Saint Kitts and Nevis', 'Basseterre', '.kn', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-KN', ''],
        ...
        ['KY', 'CYM', '136', 'KYD', 'Cayman Islands Dollar', '+1-345', 'Cayman Islands', 'George Town', '.ky', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-KY', ''],
        ...
        ['LC', 'LCA', '662', 'XCD', 'East Caribbean Dollar', '+1-758', 'Saint Lucia', 'Castries', '.lc', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-LC', ''],
        ...
        ['MF', 'MAF', '663', 'EUR', 'Euro', '590', 'Saint Martin', 'Marigot', '.gp', 'NA', '019', 'Americas', '029', 'Caribbean', 'fr', ''],
        ...
        ['MQ', 'MTQ', '474', 'EUR', 'Euro', '596', 'Martinique', 'Fort-de-France', '.mq', 'NA', '019', 'Americas', '029', 'Caribbean', 'fr-MQ', '^(\d{5})$'],
        ['MR', 'MRT', '478', 'MRO', 'Ouguiya', '222', 'Mauritania', 'Nouakchott', '.mr', 'AF', '002', 'Africa', '011', 'Western Africa', 'ar-MR,fuc,snk,fr,mey,wo', ''],
        ['MS', 'MSR', '500', 'XCD', 'East Caribbean Dollar', '+1-664', 'Montserrat', 'Plymouth', '.ms', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-MS', ''],
        ...
        ['MX', 'MEX', '484', 'MXN', 'Mexican Peso', '52', 'Mexico', 'Mexico City', '.mx', 'NA', '019', 'Americas', '013', 'Central America', 'es-MX', '^(\d{5})$'],
        ...
        ['NA', 'NAM', '516', 'NAD', 'Namibia Dollar', '264', 'Namibia', 'Windhoek', '.na', 'AF', '002', 'Africa', '018', 'Southern Africa', 'en-NA,af,de,hz,naq', ''],
        ...
        ['NI', 'NIC', '558', 'NIO', 'Cordoba Oro', '505', 'Nicaragua', 'Managua', '.ni', 'NA', '019', 'Americas', '013', 'Central America', 'es-NI,en', '^(\d{7})$'],
        ...
        ['PA', 'PAN', '591', 'PAB', 'Balboa', '507', 'Panama', 'Panama City', '.pa', 'NA', '019', 'Americas', '013', 'Central America', 'es-PA,en', ''],
        ['PE', 'PER', '604', 'PEN', 'Nuevo Sol', '51', 'Peru', 'Lima', '.pe', 'SA', '019', 'Americas', '005', 'South America', 'es-PE,qu,ay', ''],
        ...
        ['PM', 'SPM', '666', 'EUR', 'Euro', '508', 'Saint Pierre and Miquelon', 'Saint-Pierre', '.pm', 'NA', '019', 'Americas', '021', 'Northern America', 'fr-PM', '^(97500)$'],
        ['PN', 'PCN', '612', 'NZD', 'New Zealand Dollar', '870', 'Pitcairn', 'Adamstown', '.pn', 'OC', '009', 'Oceania', '061', 'Polynesia', 'en-PN', ''],
        ['PR', 'PRI', '630', 'USD', 'US Dollar', '+1-787 and 1-939', 'Puerto Rico', 'San Juan', '.pr', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-PR,es-PR', '^00[679]\d{2}(?:-\d{4})?$'],
        ...
        ['PY', 'PRY', '600', 'PYG', 'Guarani', '595', 'Paraguay', 'Asuncion', '.py', 'SA', '019', 'Americas', '005', 'South America', 'es-PY,gn', '^(\d{4})$'],
        ...
        ['SA', 'SAU', '682', 'SAR', 'Saudi Riyal', '966', 'Saudi Arabia', 'Riyadh', '.sa', 'AS', '142', 'Asia', '145', 'Western Asia', 'ar-SA', '^(\d{5})$'],
        ...
        ['SR', 'SUR', '740', 'SRD', 'Surinam Dollar', '597', 'Suriname', 'Paramaribo', '.sr', 'SA', '019', 'Americas', '005', 'South America', 'nl-SR,en,srn,hns,jv', ''],
        ...
        ['SV', 'SLV', '222', 'USD', 'US Dollar', '503', 'El Salvador', 'San Salvador', '.sv', 'NA', '019', 'Americas', '013', 'Central America', 'es-SV', '^(?:CP)*(\d{4})$'],
        ['SX', 'SXM', '534', 'ANG', 'Netherlands Antillean Guilder', '599', 'Sint Maarten', 'Philipsburg', '.sx', 'NA', '019', 'Americas', '029', 'Caribbean', 'nl,en', ''],
        ...
        ['TC', 'TCA', '796', 'USD', 'US Dollar', '+1-649', 'Turks and Caicos Islands', 'Cockburn Town', '.tc', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-TC', '^(TKCA 1ZZ)$'],
        ...
        ['TT', 'TTO', '780', 'TTD', 'Trinidad and Tobago Dollar', '+1-868', 'Trinidad and Tobago', 'Port of Spain', '.tt', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-TT,hns,fr,es,zh', ''],
        ...
        ['US', 'USA', '840', 'USD', 'US Dollar', '1', 'United States', 'Washington', '.us', 'NA', '019', 'Americas', '021', 'Northern America', 'en-US,es-US,haw,fr', '^\d{5}(-\d{4})?$'],
        ['UY', 'URY', '858', 'UYU', 'Peso Uruguayo', '598', 'Uruguay', 'Montevideo', '.uy', 'SA', '019', 'Americas', '005', 'South America', 'es-UY', '^(\d{5})$'],
        ...
        ['VC', 'VCT', '670', 'XCD', 'East Caribbean Dollar', '+1-784', 'Saint Vincent and the Grenadines', 'Kingstown', '.vc', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-VC,fr', ''],
        ['VE', 'VEN', '862', 'VEF', 'Bolivar', '58', 'Venezuela (Bolivarian Republic of)', 'Caracas', '.ve', 'SA', '019', 'Americas', '005', 'South America', 'es-VE', '^(\d{4})$'],
        ['VG', 'VGB', '092', 'USD', 'US Dollar', '+1-284', 'Virgin Islands (British)', 'Road Town', '.vg', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-VG', ''],
        ['VI', 'VIR', '850', 'USD', 'US Dollar', '+1-340', 'Virgin Islands (U.S.)', 'Charlotte Amalie', '.vi', 'NA', '019', 'Americas', '029', 'Caribbean', 'en-VI', '^008\d{2}(?:-\d{4})?$'],
     ...
     * <code>
     *      Example:  For France
     *      $myObject->getCountryRegionCode('fra');
     *      $myObject->getCountryRegionCode('fr');
     *      $myObject->getCountryRegionCode('250');
     * </code>
     *
     * @param $IsoCode
     * @return string
     * @throws \Exception
     */
    public function getCountryRegionCode($IsoCode)
    {
        if($countryDatas = $this->getCountryInfos($IsoCode,true))
